...
import org.wso2.carbon.logging.view.appenders.CarbonMemoryAppender;
...
public class InMemoryLogProvider implements LogProvider {
    ...
    @Override
    public List<String> getApplicationNames(String tenantDomain, String serverKey) throws
                                                                                   LogViewerException {
    ...
    private boolean isCurrentTenantId(String tenantId, String domain) {
        ...
        if ("".equals(domain)) {
            ...
            try {
                currTenantId = String.valueOf(MultitenantConstants.SUPER_TENANT_ID);
                return currTenantId.equals(tenantId);
            } catch (Exception e) {
